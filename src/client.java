...
public class client {
    public static void main(String[] args) throws IOException {
        ...
        System.out.println("Attempting to connect to host " + serverHostname + " on port 80.");
        Socket echoSocket = null;
        PrintWriter out = null;
        BufferedReader in = null;
        try {
            echoSocket = new Socket(serverHostname, 2345);
        ...
        while ((userInput = stdIn.readLine()) != null) {
            ...
            try {
                ...
                if(userInput.equalsIgnoreCase("aloha")){
                
                    System.out.println("Server: Welcome");
                    response = "Welcome";
                }
                if(response.equalsIgnoreCase("Welcome")){
                    System.out.println("Server: Send files now...");
                }
