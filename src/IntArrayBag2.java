...
* @see IntLinkedBag
******************************************************************************/
public class IntArrayBag2 implements Cloneable
{
   ...
   **/   
   public IntArrayBag2(int initialCapacity)
   {
   ...
   **/
   public void add(int i)
   {
      ...
      data[manyItems] = element.super.clone();
      manyItems++;
   }
   ...
   **/
   public void addAll(IntArrayBag2 addend)
   {
   ...
   **/ 
   public IntArrayBag2 clone( )
   {  // Clone an IntArrayBag object.
      IntArrayBag2 answer;
      
      try
      {
         answer = (IntArrayBag2) super.clone( );
      }
   ...
   *   a different bag implementation.
   **/   
   public static IntArrayBag2 union(IntArrayBag2 b1, IntArrayBag2 b2)
   {
      // If either b1 or b2 is null, then a NullPointerException is thrown. 
      // In the case that the total number of items is beyond
      // Integer.MAX_VALUE, there will be an arithmetic overflow and
      // the bag will fail.   
      IntArrayBag2 answer = new IntArrayBag2(b1.getCapacity( ) + b2.getCapacity( ));
   ...
   public static IntArrayBag2 minus(IntArrayBag2 b2,IntArrayBag2 b1)
   {  
      IntArrayBag2 b3 = b2.clone();
